import { useLogger, useNuxt, addDevServerHandler, addVitePlugin, createResolver, defineNuxtModule, addTemplate, addBuildPlugin, resolvePath, resolveAlias } from '@nuxt/kit';
import jiti from 'jiti';
import { join, relative, resolve, extname, dirname } from 'pathe';
...
const google = {
  ...
  async resolveFontFaces(fontFamily, defaults) {
    ...
    return {
      fonts: await cachedData(`google:${fontFamily}-${hash(defaults)}-data.json`, () => getFontDetails$5(fontFamily, defaults), {
        onError(err) {
...
const googleicons = {
  ...
  async resolveFontFaces(fontFamily, defaults) {
    ...
    return {
      fonts: await cachedData(`googleicons:${fontFamily}-${hash(defaults)}-data.json`, () => getFontDetails$4(fontFamily), {
        onError(err) {
