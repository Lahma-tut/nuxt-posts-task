...
interface NormalizedFontFaceData extends Omit<FontFaceData, 'src' | 'unicodeRange'> {
...
interface ResolveFontFacesOptions {
    weights: string[];
...
interface FontFamilyProviderOverride extends FontFamilyOverrides, Partial<Omit<ResolveFontFacesOptions, 'weights'> & {
    weights: Array<string | number>;
}> {
    /** The provider to use when resolving this font. */
    provider?: FontProviderName;
}
interface FontFamilyManualOverride extends FontFamilyOverrides, FontFaceData {
...
export type { FontProvider as F, LocalFontSource as L, ModuleHooks as M, NormalizedFontFaceData as N, ResolveFontFacesOptions as R, ModuleOptions as a, FontFaceData as b, FontFallback as c, FontFamilyManualOverride as d, FontFamilyOverrides as e, FontFamilyProviderOverride as f, FontProviderName as g, RemoteFontSource as h, FontSource as i };
